<script>
    var lag = '{$station.lng}', lat = '{$station.lat}';
</script>
{literal}
<script>
    ...
    $(function () {
        ...
        var uploader = WebUploader.create({
            ...
            accept: {
                ...
                mimeTypes: 'image/jpg,image/jpeg,image/png' // 不改就会很慢
            }
        });
        ...
        map.clearOverlays();
        var point = new BMap.Point(lag, lat); // TODO: 中心点;创建点坐标
